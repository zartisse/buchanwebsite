import type { CaseStudyData } from '../components/public/CaseStudyPage';

export const BUILDER_TRANSITION_CASE_STUDY: CaseStudyData = {
  slug: 'builder-transition',
  metaTitle: 'Builder Transition Case Study',
  metaDescription: 'How John Buchan Homes took over a mid-construction custom home on the Eastside and delivered a result the clients love.',
  hero: {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'Plan revisions from the prior builder had not been fully reconciled with structural engineering. Interior volumes were resolved, but exterior material transitions and mechanical routing needed constructability review. The clients wanted to preserve design intent while eliminating latent defects.',
    },
    {
    ...
    },
    {
      ...
      body: 'The highest risk was morale and decision fatigue. The clients had already invested two years. Our preconstruction lead re-established a single decision log, weekly owner walkthroughs, and a concierge point of contact so nothing fell between trades.',
    },
    {
      title: "Buchan's solution",
      body: 'We executed a formal takeover agreement: site safety reset, third-party framing inspection, and a 30-day stabilization plan before aesthetic work resumed. Trades were re-mobilized under Buchan supers already known to Eastside inspectors. Transparent draw schedules tied payments to verifiable milestones.',
    },
  ],
  result:
