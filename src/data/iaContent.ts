...
export const IA_PAGES: Record<string, HubPageData> = {
  'custom-homes': {
    ...
    sections: [
      ...
      {
        title: 'Cost & Planning',
        body: 'Transparent progressive estimates before construction begins. Use our cost estimator for a preliminary range, then meet with our preconstruction team for a project-specific conversation.',
        bullets: ['Online cost estimator', 'Preconstruction planning', 'Progressive budget ranges'],
      },
      {
        title: 'What Makes a Buchan Custom Home',
        body: 'Hand-chosen materials, rain-screen detailing built for Pacific Northwest weather, and interior volumes resolved before finish work begins. The details you never see are the ones we lose sleep over.',
      },
    ],
  ...
  renovations: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Renovations benefit from the same progressive estimating and planning discipline as custom builds. Living-in-place, phasing, and permit timelines are mapped before demolition begins.',
      },
      {
  ...
  preconstruction: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'A clear preconstruction agreement transitions your project into build with aligned expectations on cost, schedule, and quality. No handoffs to a different team.',
        image_url: '/assets/ph-arch-4.png',
      },
    ],
    ...
    sections: [
      {
        ...
        body: 'Bellevue, Medina, Clyde Hill, Yarrow Point, Hunts Point, Kirkland, Redmond, Newcastle, Mercer Island, Sammamish, Issaquah, Woodinville, and Bothell.',
        bullets: ['Bellevue & Bridle Trails', 'Clyde Hill & Medina', 'Kirkland & Juanita', 'Redmond & Sammamish'],
        image_url: '/assets/ph-arch-2.png',
      },
      {
  ...
  adus: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Recent state and local ADU reforms may affect your property. We track Bellevue, Kirkland, Seattle-adjacent, and unincorporated King County rules so you understand what is possible before investing in design.',
      },
      {
        title: 'Timelines & Budget',
        body: 'Most ADU projects run 10–14 months from feasibility to completion, depending on jurisdiction and utility work. Preliminary ranges are available through our cost estimator; detailed budgets follow preconstruction.',
      },
    ],
  ...
  'fire-restoration': {
    ...
    hero: {
      eyebrow: 'Fire Restoration',
      title: 'Restore with',
      titleEmphasis: 'care.',
      image_url: '/assets/ph-arch-4.png',
    },
    intro: 'Emergency response coordination and rebuild services for fire-damaged homes. Available through Services and Contact when you need a builder who understands insurance, structure, and finish quality together.',
    sections: [
      {
        title: 'Immediate Response',
        body: 'Secure the site, assess structural integrity, and develop a recovery plan with your insurance partners. We document conditions thoroughly before any demolition.',
        image_url: '/assets/ph-arch-2.png',
      },
      {
        title: 'Insurance Coordination',
        body: 'We work alongside adjusters and engineers with clear scope documentation, photo logs, and milestone-based billing so your claim stays on track.',
        bullets: ['Structural assessment', 'Scope documentation', 'Phased recovery plan'],
      },
      {
  ...
  'planning-budgeting': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Energy code, fire separation, stormwater, and accessibility requirements are mapped into the budget from the start, not discovered at permit submittal.',
      },
      {
        title: 'Cost Tool & Next Steps',
        body: 'Get a preliminary range with our online estimator, then follow up for a project-specific conversation. Planning services can stand alone or lead into a full preconstruction agreement.',
        bullets: ['Online cost estimator', 'Preconstruction agreement', 'Design coordination'],
      },
    ],
    ctaTitle: 'How much will my project cost?',
    ctaLink: 'https://estimator.buchan.com/',
  },
  'real-estate': {
    slug: 'real-estate',
  ...
  'find-your-lot': {
    ...
    sections: [
      ...
      {
        title: 'Next Steps',
        body: 'Share your criteria through our contact form or call 425.827.2266. We will outline active opportunities and off-market relationships where appropriate.',
      },
    ],
  ...
  'sell-your-home': {
    ...
    sections: [
      ...
      {
        title: 'Timing With Your Build',
        body: 'Align your sale with construction milestones so you are never between homes without a plan. Bridge scenarios, rent-backs, and phased move-outs are mapped early.',
      },
      {
      ...
      },
      {
        ...
        body: 'One team knows both sides of your transition. Your builder and brokerage share a timeline so decisions on one property support the other.',
      },
    ],
  ...
  'home-care': {
    ...
    sections: [
      ...
      {
        title: 'Who It Is For',
        body: 'Past Buchan clients, Eastside homeowners with complex systems, and owners who prefer a single trusted team over a rotating list of contractors.',
      },
      {
    ...
    sections: [
      {
        ...
        body: 'Buildable residential lots, teardown candidates, and infill parcels across the Eastside. Size, slope, and utility access all factor into whether a direct conversation makes sense.',
        bullets: ['Single-family residential lots', 'Teardown / rebuild candidates', 'Infill & subdivision remnants'],
        image_url: '/assets/ph-arch-4.png',
      },
      {
      ...
      },
      {
        ...
        body: 'Land conversations stay private. We do not market your property to third parties while evaluating a direct purchase.',
      },
    ],
...
/** @deprecated Use JOURNEY_PATHS */
export const HOME_STARTING_POINTS = {
  anchor: JOURNEY_PATHS.filter((p) => p.group === 'anchor'),
  core: JOURNEY_PATHS.filter((p) => p.group === 'core'),
  secondary: JOURNEY_PATHS.filter((p) => p.group === 'secondary'),
};
