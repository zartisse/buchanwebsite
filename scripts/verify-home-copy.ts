...
const expectations: Array<[string, boolean]> = [
  ...
  ['google reviews eyebrow', content.google_reviews_section.eyebrow === 'Client Testimonials'],
  ['google reviews title', content.google_reviews_section.title.startsWith('What our clients say')],
  ['google reviews fallback', !!content.google_reviews_section.fallback_maps_url?.includes('google.com/maps')],
  ['no em dashes in hero', !content.hero.subtitle?.includes('—')],
  ...
  ['content version', (content as { content_version?: number }).content_version === 4],
